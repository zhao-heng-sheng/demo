...
import { defineComponent, unref, useSSRContext, ref, toRef, computed, h } from 'vue';
import { u as useAppConfig } from './config-27fab80d.mjs';
import { ssrRenderClass, ssrInterpolate, ssrRenderComponent } from 'vue/server-renderer';
import { pxfy, depx, changeColor } from 'seemly';
import { useMergedState } from 'vooks';
import { c as cB, a as cE, i as iconSwitchTransition, b as c, d as cM, e as cNotM, u as useTheme, f as useConfig, g as useFormItem, h as createKey, j as useThemeClass, k as isSlotEmpty, r as resolveWrappedSlot, N as NIconSwitchTransition, l as NBaseLoading, m as commonLight, n as call } from './light-5608818b.mjs';
import 'ofetch';
import 'hookable';
import 'unctx';
import 'h3';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="${ssrRenderClass({ dark: unref(appConfig).theme.dark })}"><p class="bg-blue-300 dark:bg-slate-600 dark:text-slate-200">appConfig: ${ssrInterpolate(unref(appConfig).title)}</p><label> dark mode: `);
      ...
      _push(`</label></div><p class="bg-blue-300 dark:bg-slate-600 dark:text-slate-200">runtimeConfig.public.apiBase: ${ssrInterpolate(unref(runtimeConfig).public.apiBase)}</p><!--]-->`);
    };
  }
});
...
//# sourceMappingURL=config-ada68bf1.mjs.map
