import { h, defineComponent, withAsyncContext, mergeProps, unref, isRef, withCtx, createTextVNode, useSSRContext, inject, ref, toRef, computed, getCurrentInstance, watchEffect, watch, provide, Fragment, renderSlot, nextTick, Transition } from 'vue';
import { u as useAsyncData } from './asyncData-3a519a0f.mjs';
import { b as useRoute, a as useState, s as storeToRefs, e as useRouter } from '../server.mjs';
...
import { _ as __nuxt_component_0$1, u as useRtl } from './Button-fd527451.mjs';
import { c as cB, b as c, d as cM, a as cE, u as useTheme, i as iconSwitchTransition, e as cNotM, o as configProviderInjectionKey, p as commonVariables$1, f as useConfig, g as useFormItem, h as createKey, j as useThemeClass, r as resolveWrappedSlot, q as resolveSlot, s as createInjectionKey, t as resolveSlotWithProps, v as useStyle, N as NIconSwitchTransition, l as NBaseLoading, m as commonLight, n as call } from './light-5608818b.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data, pending } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(fetchPost, "$qTwq0iy38b")), __temp = await __temp, __restore(), __temp);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_NButton = __nuxt_component_0$1;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "p-5" }, _attrs))}>`);
      if (unref(pending)) {
        _push(`<div>\u52A0\u8F7D\u4E2D...</div>`);
      } else {
        _push(`<div><h1 class="text-2xl">${ssrInterpolate((_a = unref(data)) == null ? void 0 : _a.title)}</h1><div>${(_b = unref(data)) == null ? void 0 : _b.content}</div><div class="py-2">`);
...
//# sourceMappingURL=_id_-a48a5840.mjs.map
