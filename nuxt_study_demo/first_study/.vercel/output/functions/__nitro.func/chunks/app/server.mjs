...
function useHead(input, options = {}) {
  ...
  const head = injectHead();
  if (head) {
    const isBrowser2 = !!((_a = head.resolvedOptions) == null ? void 0 : _a.document);
...
const appHead = { "meta": [{ "name": "viewport", "content": "width=device-width, initial-scale=1" }, { "charset": "utf-8" }, { "name": "description", "content": "My amazing site." }, { "name": "charset", "content": "utf-8" }], "link": [], "style": [], "script": [], "noscript": [], "charset": "utf-8", "viewport": "width=device-width, initial-scale=1", "title": "My App" };
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/config-ada68bf1.mjs').then((m) => m.default || m)
  },
  {
    name: "counter",
    path: "/counter",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/counter-47aa41d6.mjs').then((m) => m.default || m)
  },
  {
    name: "detail-id",
    path: "/detail/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_id_-a48a5840.mjs').then((m) => m.default || m)
  },
  {
    name: "hello",
    path: "/hello",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/hello-8dd8fd60.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-4da9b6e0.mjs').then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/login-8e28b10d.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./_nuxt/default-b489a240.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-dc045cc2.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, useState as a, useRoute as b, createError as c, defineStore as d, entry$1 as default, useRouter as e, useNuxtApp as f, useHead as g, defineAppConfig as h, useSsrAdapter as i, navigateTo as n, storeToRefs as s, useRuntimeConfig as u };
